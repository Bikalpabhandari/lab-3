...
document.addEventListener('DOMContentLoaded', (loaded) =>{
 ...
 // adding new row using id ex2 and css it
    document.getElementById("ex2").innerHTML = "<h4>New rows using h4</h4>"  + "<p>HHAHAHAHHAHAHAHAHHAHAHAHHAHAHHAHAHAHAHAHAHHAH</p>";
    document.getElementById("ex2").style.color = "#f8f8f8";
    document.getElementById("ex2").style.padding = "2% 20%";
//add some images and styling it
let newImageEx2 = document.createElement("img");
newImageEx2.id = "new-image-ex2";  // Set id for later selection
newImageEx2.src = "./img/logo.png"; // Replace with your image path
newImageEx2.alt = "New content image";
newImageEx2.style.width = "300px"; // Example styling for the image
 });